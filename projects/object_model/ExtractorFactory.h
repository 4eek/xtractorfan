/**
 * $Id: ExtractorFactory.h 5 2008-09-07 21:45:28Z kevin $
 *
...
#include <object_model/ExtractorAdapter.h>

struct ExtractorFactory : public ObjectAdapter<ExtractorAdapter, C_Extractor> {
    ...
    static IExtractor * createExtractor(const std::string & objectType) {
        void * extractor = PluginManager::getInstance().createObject(objectType, getInstance());
        return (IExtractor *) extractor;
    }
};
