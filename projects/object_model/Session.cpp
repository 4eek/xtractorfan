/**
 * $Id: Session.cpp 5 2008-09-07 21:45:28Z kevin $
 *
...
static C_ExtractorInfo * getSelfInfo_(C_SessionHandle handle) {
    ISession * t = reinterpret_cast<Session *> (handle);
    return t->getSelfInfo();
}

Session::Session() {
    C_Session::handle = (C_SessionHandle)this;
    C_Session::getSelfInfo = getSelfInfo_;
}

Session::~Session() {
}

ExtractorInfo * Session::getSelfInfo() {
    return self;
}
