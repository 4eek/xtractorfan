/**
 * $Id: c_plugin.c 5 2008-09-07 21:45:28Z kevin $
 *
...
PLUGIN_API PF_ExitFunc PF_initPlugin(const PF_PlatformServices * params) {
    ...
    // Register StandardSharedCExample
    rp.createFunc = StandardSharedCExample_create;
    rp.destroyFunc = StandardSharedCExample_destroy;
    rp.programmingLanguage = PF_ProgrammingLanguage_C;

    res = params->registerObject((const apr_byte_t *) "StandardSharedCExample", &rp);
    if (res < 0)
        return NULL;
