/**
 * $Id: StandardSharedCXXExample2.h 5 2008-09-07 21:45:28Z kevin $
 *
...
#ifndef STANDARD_SHARED_CXX_EXAMPLE2_H
#define STANDARD_SHARED_CXX_EXAMPLE2_H
...
class StandardSharedCXXExample2 : public IExtractor {
public:

    // static plugin interface
    static void * create(PF_ObjectParams *);
    static apr_int32_t destroy(void *);
    ~StandardSharedCXXExample2();
