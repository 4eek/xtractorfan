/**
 * $Id: StandardStaticExample.h 5 2008-09-07 21:45:28Z kevin $
 *
...
#ifndef STANDARD_STATIC_EXAMPLE 
#define STANDARD_STATIC_EXAMPLE
...
class StandardStaticExample : public IExtractor {
public:

    // static plugin interface
    static void * create(PF_ObjectParams *);
    static apr_int32_t destroy(void *);
    ~StandardStaticExample();
