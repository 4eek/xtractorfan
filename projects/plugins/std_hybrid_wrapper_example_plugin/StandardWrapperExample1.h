/**
 * $Id: StandardWrapperExample1.h 5 2008-09-07 21:45:28Z kevin $
 *
...
#ifndef STANDARD_WRAPPER_EXAMPLE1_H
#define STANDARD_WRAPPER_EXAMPLE1_H

#include <object_model/ExtractorModel.h>
#include <object_model/ExtractorBaseTemplate.h>

struct PF_ObjectParams;

class StandardWrapperExample1 : public ExtractorBaseTemplate<StandardWrapperExample1> {
public:
    StandardWrapperExample1(PF_ObjectParams *);

    // IExtractor methods
    virtual void getInitialInfo(ExtractorInfo * info);
    virtual void run(ISession * sessionInfo);
    // TODO: resource below needs to be a string or more complex object
