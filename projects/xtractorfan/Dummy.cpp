/**
 * $Id: Dummy.cpp 5 2008-09-07 21:45:28Z kevin $
 *
...
void Dummy::getInitialInfo(ExtractorInfo * info) {
    ::strcpy((char *) info->name, "Dummy");
    ::strcpy((char *) info->desc, "Dummy Plugin");
}

void Dummy::run(ISession * sessionInfo) {
}
